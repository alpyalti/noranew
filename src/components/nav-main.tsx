                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <SidebarMenuButton
                      ...
                      className={`pl-2 ${isCompact ? 'pr-2' : 'pr-8'} mx-0 rounded-md w-full relative cursor-pointer ${item.isActive ? 'bg-primary/20 dark:bg-primary/30 font-semibold shadow-sm' : ''}`}
                    >
                  ...
                  {item.items.map((subItem) => (
                    <SidebarMenuSubItem key={`${id || "default"}-${item.title}-${subItem.title}`}>
                      <SidebarMenuSubButton 
                        ...
                        className={`pl-4 pr-3 mx-2 py-1 rounded-md w-[calc(100%-16px)] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground cursor-pointer ${subItem.isActive ? 'bg-primary/20 dark:bg-primary/30 font-semibold shadow-sm' : ''}`}
                      >
                        {subItem.title}
                        {subItem.isActive && (
